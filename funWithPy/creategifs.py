...
def stackIt(path):
  ...
  frame = ["./comicframesh.png", "./comicframesh.png", "./comicframesh.png", "./comicframesh.png", "./comicframesh.png", "./comicframesh.png", "./comicframesh.png", "./comicframesh.png", "./comicframesh.png", "./comicframesh.png"]
